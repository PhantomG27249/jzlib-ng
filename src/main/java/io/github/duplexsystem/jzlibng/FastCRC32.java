 ...
 * @since 1.1
 */
public class FastCRC32 implements Checksum {
    private int crc;
    ...
    public void update(ByteBuffer buffer) {
        ...
        if (buffer.isDirect()) {
            try {
                crc = updateByteBuffer(crc, UnsafeUtils.getFieldLong(buffer, "address"), pos, rem);
            } finally {
    ...
    public static native void initSymbols(String str);
}
