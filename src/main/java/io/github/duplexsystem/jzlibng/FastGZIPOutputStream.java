...
public class FastGZIPOutputStream extends FastDeflaterOutputStream {
     ...
     * @since 1.7
     */
    public FastGZIPOutputStream(OutputStream out, int size, boolean syncFlush)
            throws IOException
    {
        super(out, out != null ? new FastDeflater(FastDeflater.DEFAULT_COMPRESSION, true) : null,
                size,
                syncFlush);
     ...
     * @since 1.7
     */
    public FastGZIPOutputStream(OutputStream out, boolean syncFlush)
            throws IOException
    {
